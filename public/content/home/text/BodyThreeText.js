...
const Text = {
    ...
    Text5: "Direct-to-patient shipping eliminates delays and improves compliance.",
    Text6: "Dedicated support team helps with claims and documentation.",
    Text7: "End-to-end solution that supports your practice every step of the way."
};
